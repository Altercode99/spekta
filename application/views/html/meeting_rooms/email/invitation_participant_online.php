...
<div>
    ...
    <div style="<?= $style['body'] ?>">
        <p>Dear Bapak/Ibu <b><?= $emp->employee_name ?></b>,</p>
        <p>Berikut ini adalah <b>Undangan <?= $type ?> (Online)</b> dari <b><?= "$meeting->employee_name ($meeting->sub_department)" ?></b> dengan Nomor: <b><?= $meeting->id ?></b></p>
        ...
        <table style="<?= $style['table']  ?>">
            ...
            <tr>
                <td style="<?= $style['td'] ?>">Link Meeting</td>
                <td style="<?= $style['td'] ?>"><?= $meeting->link ?></td>
            </tr>
        </table>
    </div>
