...
<div>
    ...
    <div style="<?= $style['body'] ?>">
        <p>Dear Team,</p>
        <p>Berikut ini adalah <b>Notifikasi Penggantian Kendaraan Dinas</b> untuk perjalanan ke <b><?= $data->destination ?></b> yang akan dilaksanakan pada</p>
        ...
        <table style="<?= $style['table'] ?>">
            ...
            <tr>
                <td style="<?= $style['td'] ?>">Nama Kendaraan Pengganti</td>
