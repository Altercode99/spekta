...
<div>
    ...
    <div style="<?= $style['body'] ?>">
        <p>Dear Team,</p>
        <p>Berikut ini adalah <b>Notifikasi Perjalanan Dinas</b> yang telah <b style='color: red'>ditolak</b> oleh <b><?= empName() ?></b> pada</P>
        ...
        <table style="<?= $style['table'] ?>">
            ...
            <tr>
                <td style="<?= $style['td'] ?>">Alasan Penolakan</td>
                <td style="<?= $style['td'] ?>;color:red;"><?= $data->reason ?></td>
            </tr>
            <tr>
