...
$script = <<< "JS"
    ...
    function showSummaryOvertimeProviderData(tabs, year, month) {	
        ...
        sumOvtProGrid.setHeader("No,Task ID,No. Memo Lembur,Nama Karyawan,Bagian,Sub Bagian,Bagian Penyelenggara,Sub Bagian Penyelenggara,Nama Mesin,,Pelayanan Produksi,Tanggal Overtime,Waktu Mulai,Waktu Selesai,Status Hari,Jam Efektif,Jam Istirahat,Jam Ril,Jam Hit,Premi,Nominal Overtime,Makan,Biaya Makan,Status Overtime,Created At");
        ...
        sumOvtProGrid.setInitWidthsP("5,20,20,20,0,0,20,20,20,0,20,15,15,15,10,10,10,10,10,10,13,5,10,10,22");
