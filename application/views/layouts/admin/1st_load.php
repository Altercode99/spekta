	...
	function afterLogin() {
		...
		sidebar = leftRightLayout.cells("a").attachForm([
			...
			{type: "block", name: "user", offsetTop: 85, list: [
				...
				{type: "label", labelWidth: menuWidth * 0.72, label: "<div class='info-version'><div><p>S.P.E.K.T.A</p><ul><li>BETA <span id='spekta_version'></span></li></ul</div></div>"},
		...
		$(".tutorial-video").on("click", function() {
			tutorialAccordion();
		});
