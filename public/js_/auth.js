function loginFormUI() {
  let e = [
    ...
    {
      type: "label",
      label: `<div style='width:100%;display:flex;flex-direction:column;justify-content:space-between;align-items:center;border-top: 1px solid #ccc'><span style='font-family:sans-serif;margin-bottom:10px;margin-top:10px'>PT. Kimia Farma Tbk. Plant Jakarta</span><span style='font-family:sans-serif'>Developed By Hardware & Network</span><span style='margin-top:10px;font-family:sans-serif'>©Copyright ${new Date().getFullYear()}</span></div>`,
    },
  ];
  function t() {
